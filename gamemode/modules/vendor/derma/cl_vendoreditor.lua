...
function PANEL:Init()
	...
	self.sellScale.OnValueChanged = function(this, value)
		if (this.noSend) then
			...
			timer.Create("axVendorScale", 1, 1, function()
	...
	self.faction.DoClick = function(this)
		...
		ax.gui.editorFaction = vgui.Create("axVendorFactionEditor")
		ax.gui.editorFaction.updateVendor = self.updateVendor
		ax.gui.editorFaction.entity = entity
